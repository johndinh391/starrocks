...
public:
    ...
    // out-of-bounds reads
    [[nodiscard]] virtual bool append_strings_overflow(const std::vector<Slice>& strs, size_t max_length) { return false; }
    ...
    // memory at once.
    [[nodiscard]] virtual bool append_continuous_strings(const std::vector<Slice>& strs) { return append_strings(strs); }
